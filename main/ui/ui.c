...
void ui_event_ConfigScreen(lv_event_t *e)
{
    ...
    if (event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        _ui_screen_change(ui_ConnectionScreen, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 500, 0);
    }
}
...
void ui_ConnectionScreen_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_connectionheaderlabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_connectionheadertext = lv_label_create(ui_connectionheaderlabel);
    lv_obj_set_width(ui_connectionheadertext, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_connectionheadertext, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_connectionheadertext, LV_ALIGN_CENTER);
    lv_label_set_text(ui_connectionheadertext, "WiFi Connection");
    ...
    lv_obj_clear_flag(ui_explanationlabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_qrlabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
...
void ui_ConfigScreen_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_configscreenheaderlabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_configscreenheadertext = lv_label_create(ui_configscreenheaderlabel);
    lv_obj_set_width(ui_configscreenheadertext, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_configscreenheadertext, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_clear_flag(ui_targetslabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_width(ui_targetselectlabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_targetselectlabel, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_height(ui_targetselectdropdown, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_targetselectdropdown, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_targetselectdropdown, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    ...
    lv_obj_clear_flag(ui_rtospanel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_rtossupportlabel = lv_label_create(ui_rtospanel);
    lv_obj_set_width(ui_rtossupportlabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_rtossupportlabel, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_height(ui_rtosdropdown, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_rtosdropdown, -8);
    lv_obj_set_y(ui_rtosdropdown, -1);
    lv_obj_set_align(ui_rtosdropdown, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_rtosdropdown, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    ...
    lv_obj_clear_flag(ui_flashpabel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_flashsupportcheckbox = lv_checkbox_create(ui_flashpabel);
    lv_checkbox_set_text(ui_flashsupportcheckbox, "Flash Support");
    lv_obj_set_width(ui_flashsupportcheckbox, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_flashsupportcheckbox, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_flashsupportcheckbox, LV_ALIGN_CENTER);
    lv_obj_add_state(ui_flashsupportcheckbox, LV_STATE_CHECKED);       /// States
    lv_obj_add_flag(ui_flashsupportcheckbox, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    ...
    lv_obj_clear_flag(ui_dualcorepanel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_dualcorecheckbox = lv_checkbox_create(ui_dualcorepanel);
    lv_checkbox_set_text(ui_dualcorecheckbox, "Dual Core");
    lv_obj_set_width(ui_dualcorecheckbox, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_dualcorecheckbox, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_add_state(ui_dualcorecheckbox, LV_STATE_CHECKED);       /// States
    lv_obj_add_flag(ui_dualcorecheckbox, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    ...
    lv_obj_clear_flag(ui_debuglevelpanel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_debuglevellabel = lv_label_create(ui_debuglevelpanel);
    lv_obj_set_width(ui_debuglevellabel, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_debuglevellabel, LV_SIZE_CONTENT);    /// 1
    ...
    lv_obj_set_height(ui_debuglevelodropdown, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_debuglevelodropdown, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_debuglevelodropdown, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
